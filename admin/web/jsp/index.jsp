...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="../jsp/index.jsp">电影后台管理系统</a></div>
    <div class="left_open">
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a _href="${pageContext.request.contextPath}/welcome"><i
                            class="iconfont">&#xe6a7;</i><cite>控制台</cite></a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a _href="${pageContext.request.contextPath}/movieList.html"><i
                            class="iconfont">&#xe6a7;</i><cite>电影信息管理</cite></a></li>
                    <li><a _href="${pageContext.request.contextPath}/movieTypeList"><i
                            class="iconfont">&#xe6a7;</i><cite>电影类别管理</cite></a></li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a _href="${pageContext.request.contextPath}/newsList.html"><i
                            class="iconfont">&#xe6a7;</i><cite>新闻信息管理</cite></a></li>
                    <li><a _href="${pageContext.request.contextPath}/newTypeList"><i class="iconfont">&#xe6a7;</i><cite>新闻类别管理</cite></a>
                    </li>
                </ul>
            </li>
            <li>
